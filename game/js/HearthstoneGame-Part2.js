...
Object.assign(HearthstoneGame.prototype, {
    ...
    // 右侧信息栏显示攻击力、法力、三项数字
    document.getElementById('player-attack').textContent = this.player.heroAttack;
    document.getElementById('enemy-attack').textContent = this.enemy.heroAttack;
    ...
    updateArmorDisplay(playerType, armor) {
        ...
        if (armorSpan) {
            // 只更新数值
            const valueSpan = armorSpan.querySelector('span');
            if (valueSpan) valueSpan.textContent = armor;
        }
    },
